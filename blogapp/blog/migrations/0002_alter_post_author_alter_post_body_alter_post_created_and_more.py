# Generated by Django 5.1.6 on 2025-02-09 02:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='slug',
            field=models.SlugField(max_length=100, unique=True, verbose_name='Слаг(путь)'),
        ),
        migrations.AlterField(
            model_name='post',
            name='status',
            field=models.CharField(choices=[('DF', 'Черновик'), ('PB', 'Опублковано')], default='DF', max_length=2, verbose_name='Статус поста'),
        ),
        migrations.AlterField(
            model_name='post',
            name='title',

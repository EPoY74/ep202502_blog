...
SECRET_KEY = 'django-insecure-c=h*%rpxka8j)oi-1dbvfyjrps5zur_zwv!@)e*z!yyp@su=z8'
...
INSTALLED_APPS = [
    ...
    # указываю.чтоуменя есть приложение, чтобы django 
    # запустил его
    'blog.BlogConfig',
]
...
EMAIL_HOST_PASSWORD = settings_sec.EMAIL_PASSWORD
